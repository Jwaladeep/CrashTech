...
webpackJsonp([16], {
    ...
    1491: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            var __t, __p = "",
                __e = _.escape;
			with(obj) __p += '<div class="create-graphic"><div id="4D" class="post-icon text-icon" style="background-image: url(4dCT.png);background-size:;background-repeat: space;background-size: cover;background-position-x: center;"><span class="icon-label">' + __e(__("4-Day CrashTech")) + '</span></div><div class="post-icon photo-icon" id="FD" style="background-image: url(frontend.png);background-size:;background-repeat: space;background-size: cover;background-position-x: center;"><span class="icon-label">' + __e(__("Frontend Development")) + '</span></div><div class="post-icon quote-icon" id="MS"><span class="icon-label">' + __e(__("Middleware Services")) + '</span></div><div class="post-icon link-icon" id="BD"><span class="icon-label">' + __e(__("Backend Development")) + '</span></div><div class="post-icon chat-icon" id="DSA"><span class="icon-label">' + __e(__("Data Structure & Algorithms")) + '</span></div><div class="post-icon audio-icon" id="MEAN"><span class="icon-label">' + __e(__("MEAN Stack Development")) + '</span></div><div class="post-icon video-icon" id="TIW"><span class="icon-label">' + __e(__("Technical Interview Workshop")) + "</span></div></div>";
            return __p
        }.toString()).apply(void 0, _values(_imports))
    },
	112: function(){
