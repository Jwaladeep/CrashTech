...
Tumblr.IndashBlog || (Tumblr.IndashBlog = {}), Tumblr.IndashBlog.Header || (Tumblr.IndashBlog.Header = {}),
    ...
    function(t) {
        ...
        Tumblr.PostsView = Backbone.View.extend({
            el: "#posts",
            initialize: function() {
                this.collection = Tumblr.Posts, this.postViews = [], this.trendingExplorePosts = [], this.form_key = t("#tumblr_form_key").attr("content"), this.createPostsAndAds(), this.listenTo(Tumblr.AutoPaginator, "after", this.createPostsAndAds), this.listenTo(e, "posts:load", this.createPostsAndAds), this.listenTo(e, "post:like", this.likePostById), this.listenTo(e, "post:fastreblog", this.fastReblogById), this.listenTo(e, "post:embed:focus", this.embedFocus), this.listenTo(e, "post:form:success", this.postFormSubmit), this.listenTo(e, "post:view:create", this.createPostView)
            },
            createPostsAndAds: function() {
                this.createPosts(), this.createVideoAds()
            },
            ...
            createTumblrVideoPlayer: function(e, i) {
                ...
                if (n.length) {
                    var r = {
                        attributes: {
                            autoplay: "undefined" == typeof s.attributes.autoplay || Boolean(s.attributes.autoplay)
                        }
                    };
                    i && (r.attributes.isAd = !0), Tumblr.Prima.Events.trigger("CrtControl:newPlayer", n, r)
                }
            },
            ...
            setUpVideoAdVideoPlayer: function(e) {
                this.createTumblrVideoPlayer(e), t(e).attr("data-view-exists", !0)
            },
            createPost: function(e) {
                ...
                if (this.collection.add(s), this.postViews.push(n), Tumblr.Prima && Tumblr.Prima.Events) {
                    var r = s.get("sponsored");
                    this.createTumblrVideoPlayer(e, r)
                }
                return o.attr("data-view-exists", !0), Tumblr.Events.trigger("postView:createPost", {
                    view: n
                }), n.$(".explore-trending-badge").length && this.trendingExplorePosts.push(s), n
            },
        ...
        e = function() {
                ...
                init: function(e, i, o, n, h) {
                    var c, d, _, u, p, m, f, v, b, w, y, T, x, $, C, E, P, D, S, M, B, A, z = parseInt(o.get("barWidth"), 10),
                        ...
                        L = o.get("chartRangeMax"),
                        R = o.get("chartRangeClip"),
                        F = 1 / 0,
                        j = -(1 / 0);
                    for (k._super.init.call(this, e, i, o, n, h), m = 0, f = i.length; m < f; m++) M = i[m], c = "string" == typeof M && M.indexOf(":") > -1, (c || t.isArray(M)) && (C = !0, c && (M = i[m] = a(M.split(":"))), M = l(M, null), d = Math.min.apply(Math, M), _ = Math.max.apply(Math, M), d < F && (F = d), _ > j && (j = _));
                    this.stacked = C, this.regionShapes = {}, this.barWidth = z, this.barSpacing = I, this.totalBarWidth = z + I, this.width = n = i.length * z + (i.length - 1) * I, this.initTarget(), R && (x = void 0 === O ? -(1 / 0) : O, $ = void 0 === L ? 1 / 0 : L), p = [], u = C ? [] : p;
                    var H = [],
                        V = [];
                    for (m = 0, f = i.length; m < f; m++)
                        if (C)
                            for (E = i[m], i[m] = S = [], H[m] = 0, u[m] = V[m] = 0, P = 0, D = E.length; P < D; P++) M = S[P] = R ? s(E[P], x, $) : E[P], null !== M && (M > 0 && (H[m] += M), F < 0 && j > 0 ? M < 0 ? V[m] += Math.abs(M) : u[m] += M : u[m] += Math.abs(M - (M < 0 ? j : F)), p.push(M));
                        else M = R ? s(i[m], x, $) : i[m], M = i[m] = r(M), null !== M && p.push(M);
                    this.max = T = Math.max.apply(Math, p), this.min = y = Math.min.apply(Math, p), this.stackMax = j = C ? Math.max.apply(Math, H) : T, this.stackMin = F = C ? Math.min.apply(Math, p) : y, void 0 !== o.get("chartRangeMin") && (o.get("chartRangeClip") || o.get("chartRangeMin") < y) && (y = o.get("chartRangeMin")), void 0 !== o.get("chartRangeMax") && (o.get("chartRangeClip") || o.get("chartRangeMax") > T) && (T = o.get("chartRangeMax")), this.zeroAxis = b = o.get("zeroAxis", !0), w = y <= 0 && T >= 0 && b ? 0 : 0 == b ? y : y > 0 ? y : T, this.xaxisOffset = w, v = C ? Math.max.apply(Math, u) + Math.max.apply(Math, V) : T - y, this.canvasHeightEf = b && y < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1, y < w ? (A = C && T >= 0 ? j : T, B = (A - w) / v * this.canvasHeight, B !== Math.ceil(B) && (this.canvasHeightEf -= 2, B = Math.ceil(B))) : B = this.canvasHeight, this.yoffset = B, t.isArray(o.get("colorMap")) ? (this.colorMapByIndex = o.get("colorMap"), this.colorMapByValue = null) : (this.colorMapByIndex = null, this.colorMapByValue = o.get("colorMap"), this.colorMapByValue && void 0 === this.colorMapByValue.get && (this.colorMapByValue = new g(this.colorMapByValue))), this.range = v
                },
                getRegion: function(t, e, i) {
